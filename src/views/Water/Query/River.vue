...
export default {
  ...
  methods: {
        ...
        .then(
          response => {
            ...
            if (response.data.code == 2000) {
              this.river_information = response.data.data;
              this.initTable(1, 10, this.river_information.length);
    ...
    updataTable() {
      this.data = [];
      if (this.river_information.length >= this.page.number * this.page.size) {
        this.data = this.river_information.slice(
    ...
    searchInput() {
      this.data = this.river_information.filter(d => {
        return (
